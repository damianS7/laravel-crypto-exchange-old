...
<head>
  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" integrity="sha384-WskhaSGFgHYWDcbwN70/dfYBj47jz9qbsMId/iRN3ewGhXQFZCSftd1LZCfmhktB"
    crossorigin="anonymous">
  <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css"> @if (Cookie::get('theme') == 'light')
  <link href="{{ asset('css/exchange-light.css') }}" rel="stylesheet"> @else
  <link href="{{ asset('css/exchange-dark.css') }}" rel="stylesheet"> @endif
